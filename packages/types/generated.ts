...
export type PageableArray<T> = { data: T[]; _page: PageInfo | null; _cursor: CursorInfo | null }
...
export type AnalyzeMediaOutput = { page_counts_analyzed: BigInt; image_dimensions_analyzed: BigInt; media_updated: BigInt }
...
export type TelegramConfigInput = { token: string; chat_id: string }
...
export type Pageable<T> = { data: T; _page: PageInfo | null; _cursor: CursorInfo | null }
...
export type CreateOrUpdateNotifier = { type: NotifierType; config: NotifierConfigInput }
...
export type NotifierConfigInput = DiscordConfig | TelegramConfigInput
...
export type Notifier = { id: number; type: NotifierType; config: NotifierConfig }
 ...
 */
export type PermissionSet = UserPermission[]
...
export type PatchNotifier = { type: NotifierType | null; config: NotifierConfigInput | null }

export type SmartListViewConfig = { book_columns: ReactTableColumnSort[]; group_columns: ReactTableColumnSort[]; book_sorting: ReactTableGlobalSort[] | null; group_sorting: ReactTableGlobalSort[] | null; enable_multi_sort?: boolean | null; search?: string | null }
...
export type ServerConfig = { id: string; job_scheduler_config: JobSchedulerConfig | null }
 ...
 */
export type TelegramConfig = { encrypted_token: string; chat_id: string }
...
export type CreateTags = { tags: string[] }
...
export type NotifierType = "DISCORD" | "TELEGRAM"
...
export type AddBooksToBookClubSchedule = { books: CreateBookClubScheduleBook[] }
...
export type GetJobsParams = { load_logs?: boolean }
